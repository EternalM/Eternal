...
public class JsonApiMxd2MacroController extends BaseController {
	...
	public void macroAll(HttpServletResponse response){
		...
		stringBuffer.append("<macro name=\"采集\" hidden=\"false\" guid=\"{DE884125-DED1-446B-8C1B-C81ADF189425}\">");
